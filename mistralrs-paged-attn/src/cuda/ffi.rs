...
extern "C" {
    ...
    pub fn kvarn_flash_attn_decode(
        ...
        key_cache: *const c_void,
        value_cache: *const c_void,
        key_tail_pool: *const c_void,
        value_tail_pool: *const c_void,
        key_tail_slots: *const c_int,
        value_tail_slots: *const c_int,
        block_tables: *const c_int,
        cu_seq_lens: *const c_int,
        out: *mut c_void,
        num_seqs: c_int,
    ...
    pub fn kvarn_flash_attn_decode_mtp_cc61(
        query: *const c_void,
        key_cache: *const c_void,
        value_cache: *const c_void,
        key_tail_pool: *const c_void,
    ...
    pub fn kvarn_store_tail(
        ...
        key_tail_pool: *mut c_void,
        value_tail_pool: *mut c_void,
        slot_mapping: *const c_long,
        key_tail_slots: *const c_int,
        value_tail_slots: *const c_int,
        num_tokens: c_int,
        ...
        block_size: c_int,
        num_blocks: c_int,
        key_record_bytes: c_int,
        value_record_bytes: c_int,
        num_tail_slots: c_int,
        key_stride: c_int,
        value_stride: c_int,
        stream: CUstream,
        dtype: u32,
